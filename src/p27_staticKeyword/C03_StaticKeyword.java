...
public class C03_StaticKeyword {
    ...
    public static void main(String[] args) {
		/*
		 ...
		 Static variable ve method'lara ulasmak istedigimizde classIsmi.
		 methodIsmi yazmamiz yeterli olur.
		  ...
		  degistirilirse tum ogrenciler ve tum ogretmenler icin okul adi kalici
		  olarak degismis olur ve bu da bir uygulama icin istenmeyen bir durumdur.
		 */

        sayi = 20;
        // str="static olan main method'dan instance variable'a direk ulasamazsin";
        staticMethod();
        // staticOlmayanMethod(); // main method static
        // oldugu icin static olmayan method'u cagiramayiz
